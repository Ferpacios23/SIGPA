...
@section('sidebar-nav')
  ...
  <a href="{{ route('dashboard.admin') }}"
     ...
     style="{{ request()->routeIs('dashboard.admin') ? 'background:rgba(26,79,214,.2);color:#6ea0ff;' : '' }}">
  ...
  <a href="{{ route('admin.usuarios.index') }}"
     ...
     style="{{ request()->routeIs('admin.usuarios.*') ? 'background:rgba(26,79,214,.2);color:#6ea0ff;' : '' }}">
  ...
  <a href="{{ route('admin.roles.index') }}"
     ...
     style="{{ request()->routeIs('admin.roles.*') ? 'background:rgba(26,79,214,.2);color:#6ea0ff;' : '' }}">
  ...
  <a href="{{ route('admin.aulas.index') }}"
     class="nav-item {{ request()->routeIs('admin.aulas.*') ? 'active' : '' }}"
     style="{{ request()->routeIs('admin.aulas.*') ? 'background:rgba(26,79,214,.2);color:#6ea0ff;' : '' }}">
  ...
  <a href="{{ route('admin.equipos.index') }}"
     class="nav-item {{ request()->routeIs('admin.equipos.*') ? 'active' : '' }}"
     style="{{ request()->routeIs('admin.equipos.*') ? 'background:rgba(26,79,214,.2);color:#6ea0ff;' : '' }}">
  ...
  <a href="{{ route('admin.reportes.index') }}"
     ...
     style="{{ request()->routeIs('admin.reportes.*') ? 'background:rgba(26,79,214,.2);color:#6ea0ff;' : '' }}">
  ...
  <a href="{{ route('admin.configuracion') }}"
     ...
     style="{{ request()->routeIs('admin.configuracion') ? 'background:rgba(26,79,214,.2);color:#6ea0ff;' : '' }}">
