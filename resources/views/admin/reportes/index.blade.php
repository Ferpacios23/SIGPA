...
@section('sidebar-nav')
  ...
  <a href="{{ route('admin.reportes.index') }}" class="nav-item active" style="background:rgba(247,107,28,.15);color:#fb923c;"><svg width="16" height="16" fill="none" viewBox="0 0 24 24"><path d="M9 17H7a2 2 0 01-2-2V5a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2h-2M9 17v4m6-4v4M9 21h6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>Reportes</a>
